...
class FlightSearch:
    ...
    def check_flight(self, origin_city_code, destination_city_code, from_time, to_time):
        ...
        :param origin_city_code: (str) The IATA code of the departure city.
        :param destination_city_code: (str) The IATA code of the destination city
        :param from_time: (datetime) The departure date.
        :param to_time: (datetime) The return date.
        :return: dict or None: A dictionary containing flight offer data if the query is successfull;
        None if the is an error.
        """
        ...
        if response.status_code != 200:
            ...
            print("The was a problem with the flight search.\n"
